...
// Id doesn't exist
func GetServiceById(id int64) (v *Service, err error) {
	o := orm.NewOrm()
	v = &Service{Id: id}
	if err = o.QueryTable(new(Service)).Filter("Id", id).RelatedSel().One(v); err == nil {
		return v, nil
	}
	return nil, err
}
...
func DeleteService(id int64) (err error) {
	o := orm.NewOrm()
	v := Service{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
