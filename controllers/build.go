...
//  BuildController operations for Build
...
// @Success 201 {int} models.Build
// @Failure 403 body is empty
// @router / [post]
func (c *BuildController) Post() {
	var v models.Build
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if _, err := models.AddBuild(&v); err == nil {
...
func (c *BuildController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	v := models.Build{Id: id}
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if err := models.UpdateBuildById(&v); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
...
func (c *BuildController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	if err := models.DeleteBuild(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
